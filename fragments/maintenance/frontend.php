...
<body>
    ...
    $email = Alexplusde\Schwooops\Schwooops::getConfig('email');
    $phone = Alexplusde\Schwooops\Schwooops::getConfig('phone');
    $adress = Alexplusde\Schwooops\Schwooops::getConfig('contact');
    $more = Alexplusde\Schwooops\Schwooops::getConfig('more');
    ?>
